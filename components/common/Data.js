...
export const Data = {
    ...
    about: {
        nr: {
            ...
            txt5: 'Kort sagt, med min bakgrunn som webutvikler og min lidenskap for webdesign, er jeg godt rustet til å hjelpe bedrifter med å realisere sine digitale mål. Jeg ser frem til nye utfordringer og muligheter til å skape innovative og effektive løsninger.',
            info: [
